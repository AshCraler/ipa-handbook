...
InputBorder? getTextFieldBorder(Color borderColor, {bool focused = false}) =>
    OutlineInputBorder(
      borderSide: BorderSide(
          color: borderColor,
          width: (focused ? 2 : 1) * InfiniteSize.outlineWidth),
...
InputDecoration textFieldCircleBorder(ColorScheme colorScheme) =>
    InputDecoration(
      contentPadding: EdgeInsets.symmetric(
          horizontal: InfiniteSize.textFieldPadding, vertical: 13),
      border: OutlineInputBorder(
        borderSide: BorderSide(
            color: colorScheme.outline, width: InfiniteSize.outlineWidth),
      ...
      disabledBorder: OutlineInputBorder(
        borderSide: BorderSide(
            ...
            width: InfiniteSize.outlineWidth),
        borderRadius: BorderRadius.circular(InfiniteSize.buttonRadius),
      ),
      focusedBorder: OutlineInputBorder(
        borderSide: BorderSide(
            color: colorScheme.primary, width: InfiniteSize.outlineWidth * 2),
        borderRadius: BorderRadius.circular(InfiniteSize.buttonRadius),
      ),
      errorBorder: OutlineInputBorder(
        borderSide: BorderSide(
            color: colorScheme.error, width: InfiniteSize.outlineWidth),
        borderRadius: BorderRadius.circular(InfiniteSize.buttonRadius),
      ),
      focusedErrorBorder: OutlineInputBorder(
        borderSide: BorderSide(
            color: colorScheme.error, width: InfiniteSize.outlineWidth * 2),
        borderRadius: BorderRadius.circular(InfiniteSize.buttonRadius),
      ),
    );
